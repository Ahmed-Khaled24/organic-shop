...
export const HeroSection = () => {
    return (
        <div className="relative bg-color-[#f8f6f3] flex gap-8 max-w-7xl mx-auto py-20 before:bg-[url(/hero-section-background.png)] before:bg-no-repeat before:bg-right-bottom before:bg-size-[25%] before:block before:absolute before:left-0 before:bottom-0 before:w-full before:h-full before:opacity-25 before:z-[-1]">
